...
<div class="container" style="width:60%;">
 <h1 align="center">Add Sensors</h1>
 ...
 ?>
            <div class="col-md-3">
            <form method="POST" action="user_profile_sensors.php?action=add&id=<?php echo $row["id"];?>">
		...
		echo "
 		 <tbody>
 			<tr>
				...
				<td>
					<a href='user_profile_sensors.php?action=delete&id=".$row['id']."' > Delete </a>					
				</td>
...
<div class="container">
  ...
  <ul class="pager">
    <li><a href="user_profile_room.php">Previous</a></li>
    <li><a href="manage_profile.php">Next</a></li>
  </ul>
</div>
