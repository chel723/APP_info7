...
<div class="container" style="width:60%;">
 <h1 align="center">Select the HAG</h1>
 ...
 ?>
            ...
            <form method="POST" action="user_profile_hag.php?action=add&id=<?php echo $row["id"];?>">
		...
		echo "
 		 <tbody>
 			<tr>
				...
				<td>".$row['name']."</td>
				<td>
					<a href='user_profile_hag.php?action=delete&id=".$row['id']."' > Delete </a>					
				</td>
...
<div class="container">
  ...
  <ul class="pager">
    <li><a href="user_profile_page.html">Previous</a></li>
    <li><a href="user_profile_room.php">Next</a></li>
  </ul>
</div>
