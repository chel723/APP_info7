...
<div class="container" style="width:60%;">
 <h1 align="center">Create Rooms</h1>
 ...
 ?>
            <div class="col-md-3">
            <form method="POST" action="user_profile_room.php?action=add&id=<?php echo $row["id"];?>">
		...
		echo "
 		 <tbody>
 			<tr>
				...
				<td>".$row['name']."</td>
				<td>
					<a href='user_profile_room.php?action=delete&id=".$row['id']."' > Delete  </a>	
...
<div class="container">
  ...
  <ul class="pager">
    ...
    <li><a href="user_profile_sensors.php">Next</a></li>
  </ul>
</div>
